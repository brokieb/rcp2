...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        months: ["January", "February", "Marzec", "Kwiecień", "May", "June", "July", "August", "September", "October", "November", "December"],
                        monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                        noEventForToday: "Ten dzień będzie dostepny dopiero jutro",
                        noEventForThisDay: "Nie zarejestrowano pracy tego dnia",
                        noEventForNextDay: "Nie odkryliśmy jeszcze podrózy w czasie :)",
                        previousYearText: "Previous year",
                        nextYearText: "Next year",
                        closeSidebarText: "Close sidebar",
                        closeEventListText: "Zamknij szczegóły"
                    },
                }
            }
            _.initials.weekends = {
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        if(!hasEventToday) {
            ...
            } else if(_.$active.date >= _.$current.date){
                markup += '<p>'+_.initials.dates[_.options.language].noEventForNextDay+'</p>';
            }else {
